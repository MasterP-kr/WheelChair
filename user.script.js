        // ==UserScript==
        // @name         Krunker Powered WheelChair - MODDED
        ...
        ! function(t) {
            if ("object" == typeof exports && "undefined" != typeof module) module.exports = t();
                ...
                ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).MyGUI = t()
            }
        }(function() {
            var t = {};
            ...
            var i = function() {
                function t(e, i, n, o, s, r, h) { var l = arguments.length > 7 && void 0 !== arguments[7] && arguments[7];! function(e, i) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this), this.styles = e, this.text = i, this.size = n, this.fillStyle = s, this.fontFamily = o, this.x = r, this.y = h, this.center = l }
                var i, n;
                return i = t, (n = [{ key: "draw", value: function(t) { t.font = this.size + " " + this.fontFamily, t.fillStyle = this.fillStyle, this.center ? t.textAlign = "center" : t.textAlign = "start", t.fillText(this.text, this.x, this.y - this.styles.itemHeight / 2 + 3) } }]) && e(i.prototype, n), t
            }();
            t.default = i;
            var n = {};
            ...
            var s = function() {
                function t() {! function(e, i) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this) }
                var e, i;
                return e = t, (i = [{ key: "contains", value: function(t, e) { return this.x <= t && t <= this.x + this.width && this.y <= e - 1 && e <= this.y + this.height - 1 } }, { key: "onChange", value: function(e) { this.__onChange = e, this.children.forEach(function(i) { i instanceof t && (i.__onChange = e) }) } }, { key: "updateStats", value: function(t, e, i, n, o, s) { this.contains(t, e) && s ? (this.hovered = !0, i && (o ? this.uuid === o : s) && (this.clicked = !0)) : (i && (this.fClicked = !0), this.hovered = !1), n && s || (this.clicked = !1, this.fClicked = !1) } }]) && o(e.prototype, i), t
            }();
            n.default = s;
            var r = {};
            Object.defineProperty(r, "__esModule", { value: !0 }), r.default = void 0;
            var h, l = (h = n) && h.__esModule ? h : { default: h };
            ...
            var d = function(t) {
                function e(t, i, n, o, s, r) { var h, l, u; return function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), (l = this, u = c(e).call(this), h = !u || "object" !== a(u) && "function" != typeof u ? function(t) { if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return t }(l) : u).styles = t, h.width = 12, h.height = 12, h.leftPadding = o - 2 * h.width, h.topPadding = h.height / 2 + 2, h.x = i + h.leftPadding, h.y = n + h.topPadding, h.containerWidth = o, h.obj = s, h.name = "name", h.clicked = !1, h.hovered = !1, h.val = r, h }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), e && f(t, e)
                }(e, l.default), i = e, (n = [{ key: "toggle", value: function() { this.obj[this.val] = !this.obj[this.val], this.__onChange && this.__onChange.call(this, this.obj[this.val]) } }, {
                    key: "update",
                    value: function(t, e, i, n, o, s) {
                        var r = !this.clicked;
                        this.updateStats(t, e, i, n, o, s), this.clicked && r && this.toggle()
                    }
                }, { key: "draw", value: function(t) { this.obj[this.val] || (t.fillStyle = this.styles.checkbox.background), this.obj[this.val] && (t.fillStyle = this.styles.checkbox.checkedBg), this.hovered && !this.obj[this.val] && (t.fillStyle = this.styles.checkbox.hovered), t.fillRect(this.x, this.y, this.width, this.height) } }]) && u(i.prototype, n), e
            }();
            r.default = d;
            var y = {};
            Object.defineProperty(y, "__esModule", { value: !0 }), y.default = void 0;
            var p, v = (p = n) && p.__esModule ? p : { default: p };
            ...
            var x = function(t) {
                function e(t, i, n, o, s, r) { var h, l, a; return function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), (l = this, a = m(e).call(this, o, s), h = !a || "object" !== b(a) && "function" != typeof a ? function(t) { if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return t }(l) : a).styles = t, h.width = 89, h.height = 20, h.leftPadding = 105, h.topPadding = h.height / 2 - 6, h.x = i + h.leftPadding, h.y = n + h.topPadding, h.obj = o, h.val = s, h.min = r.min, h.max = r.max, h.step = r.step || !1, h.clicked = !1, h.hovered = !1, h.value = o[s], h }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    key: "update",
                    value: function(t, e, i, n, o, s) {
                        if (this.updateStats(t, e, i, n, o, s), this.clicked) {
                            var r = t;
                            r = Math.max(r, this.x), r = Math.min(r, this.x + this.width);
                            var h = this.max - this.min,
                                l = (r - this.x) / this.width;
                            this.value = Math.round(this.min + l * h), this.step && (this.value = Math.round(this.value / this.step) * this.step), this.obj[this.val] = this.value, this.__onChange && this.__onChange(this.obj[val])
                        }
                    }
                }, {
                    key: "draw",
                    value: function(t) {
                        this.hovered || (t.fillStyle = this.styles.slider.background), this.hovered && (t.fillStyle = this.styles.slider.hovered), t.fillRect(this.x, this.y, this.width, this.height);
                        var e = this.max - this.min,
                            i = (this.obj[this.val] - this.min) / e,
                            n = this.width * i;
                        t.fillStyle = this.styles.slider.slider, t.fillRect(this.x, this.y, n, this.height), t.fillStyle = this.styles.slider.color, t.fillText(this.obj[this.val].toString(), this.width + this.x + 5, this.y + 2 * this.topPadding + 6)
                    }
                }]) && g(i.prototype, n), e
            }();
            y.default = x;
            ...
            var P, S = (P = n) && P.__esModule ? P : { default: P };
            ...
            var M = function(t) {
                function e(t, i, n, o, s, r, h, l) { var a, u; return function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), this, (a = !(u = O(e).call(this)) || "object" !== j(u) && "function" != typeof u ? C(this) : u).styles = t, a.width = s, a.height = t.itemHeight - 4, a.topPadding = i * a.height + a.height - 4, a.x = n, a.y = o, a.val = r, a.visible = !1, a.name = r, a.hovered = !1, a.uuid = l, a.cb = h, a.hide = a.hide.bind(C(a)), a }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            var U = function(t) {
                function e(t, i, n, o, s, r, h, l, a, u, c) { var f, d;! function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), d = R(e).call(this), (f = !d || "object" !== H(d) && "function" != typeof d ? W(this) : d).styles = t, f.x = i, f.y = n, f.obj = r, f.vals = l, f.children = [], f.val = h, f.height = 24 * ("object" === H(l) ? Object.keys(l).length : Array.isArray(l) ? Array.length : 1), f.width = o, f.containerHeight = s, f.visible = !1, f.uuid = a; var y = u; return f.valsLength = c, f.delOption = f.delOption.bind(W(f)), u = function(t) { f.visible = !1, y(t) }, f.cb = u, f.buildList(), f }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    value: function() {
                        var t = this;
                        Array.isArray(this.vals) ? this.vals.forEach(function(e, i) { t.children[i].val = e }) : "object" === H(this.vals) && Object.entries(this.vals).forEach(function(e, i) { t.children[i].val = e[0] })
                    }
                }, {
                    key: "buildList",
                    value: function() {
                        var t = this;
                        this.children = [], Array.isArray(this.vals) ? this.vals.forEach(function(e, i) {
                            var n = new D.default(t.styles, i, t.x, t.y, t.width, e, t.cb, t.uuid);
                            t.children.push(n)
                        }) : "object" === H(this.vals) && Object.entries(this.vals).forEach(function(e, i) {
                            var n = new D.default(t.styles, i, t.x, t.y, t.width, e[0], t.cb, t.uuid);
                            t.children.push(n)
                        })
                    }
                    ...
                    value: function() {
                        var t = this;
                        this.children.forEach(function(e) { e.y = t.y + e.topPadding, e.x = t.x, e.updatePos && e.updatePos() })
                    }
                }, {
                    key: "update",
                    value: function(t, e, i, n, o, s) {
                        var r = this;
                        this.updateStats(t, e, i, n, o, s), this.children.forEach(function(t) { return t.visible = r.visible })
                    }
                }, { key: "draw", value: function() {} }]) && L(i.prototype, n), e
            }();
            E.default = U;
            var Y = {};
            Object.defineProperty(Y, "__esModule", { value: !0 }), Y.default = void 0;
            ...
            function K(t) { return (K = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) { return t.__proto__ || Object.getPrototypeOf(t) })(t) }
            ...
            var Q = function(t) {
                ...
                return function(t, e) {
                    ...
                    value: function() {
                        var t = this;
                        if (Array.isArray(this.vals)) this.valText = this.vals[this.obj[this.val]], this.valText || (this.valText = this.obj[this.val]);
                        else if ("object" === V(this.vals)) {
                            var e = Object.entries(this.vals).find(function(e) { return e[1] === t.obj[t.val] });
                            this.valText = e[0]
                        }
                    }
                }, {
                    key: "updateInfo",
                    value: function(t) {
                        if ("string" == typeof this.vals) this.obj[this.val] = this.vals[t];
                        else if (Array.isArray(this.vals)) "string" == typeof this.obj[this.val] ? this.obj[this.val] = this.vals[this.vals.indexOf(t)] : this.obj[this.val] = this.vals.indexOf(t);
                        else if ("object" === V(this.vals)) {
                            var e = Object.entries(this.vals).find(function(e) { return e[0] === t });
                            this.obj[this.val] = e[1]
                        }
                        this.valText = t, this.__onChange && this.__onChange(this.obj[this.val]), this.dropDown.updateInfo(this.vals, this.obj[this.val]), this.visible = !1
                    }
                }, { key: "uuidv4", value: function() { return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, function(t) { return (t ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> t / 4).toString(16) }) } }, {
                    key: "update",
                    value: function(t, e, i, n, o, s, r) {
                        var h = !this.clicked;
                        this.updateStats(t, e, i, n, o, s, r), this.clicked && h && (this.dropDown.visible = !0, this.visible = !0, this.cb())
                    }
                }, { key: "hideAll", value: function() { this.visible = !1, this.children.forEach(function(t) { t.hide() }) } }, {
                    key: "updatePos",
                    value: function() {
                        var t = this;
                        this.children.forEach(function(e) { e.y = t.y, e.x = t.x, e.updatePos && e.updatePos() })
                    }
                }, { key: "delVal", value: function(t) { this.dropDown.delOption(t) } }, { key: "draw", value: function(t) { t && (t.strokeStyle = this.styles.select.outline, this.hovered || (t.fillStyle = this.styles.select.background), this.hovered && (t.fillStyle = this.styles.select.hovered), t.lineWidth = 1, t.strokeRect(this.x, this.y - this.topPadding / 2, this.width, this.height), t.fillRect(this.x, this.y - this.topPadding / 2, this.width, this.height), t.fillStyle = this.styles.select.color, t.font = this.styles.item.fontSize + " " + this.styles.fontFamily, t.fillText(this.valText, this.x + 4, this.y - 10 + this.height), t.beginPath(), t.moveTo(this.x + this.width - 10, this.y + this.topPadding - 5), t.lineTo(this.x + this.width - 4, this.y + this.topPadding - 5), t.lineTo(this.x + this.width - 7, this.y + this.topPadding + 2), t.closePath(), t.fill()) } }]) && J(i.prototype, n), e
            }();
            Y.default = Q;
            var q = {};
            Object.defineProperty(q, "__esModule", { value: !0 }), q.default = void 0;
            var Z, $ = (Z = n) && Z.__esModule ? Z : { default: Z };
            ...
            function ft(t) { return (ft = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) { return t.__proto__ || Object.getPrototypeOf(t) })(t) }

            function dt(t) { if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return t }

            function yt(t, e) { return (yt = Object.setPrototypeOf || function(t, e) { return t.__proto__ = e, t })(t, e) }
            var pt = function(t) {
                function e(t, i, n, o, s, r, h) { var l, a; return function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), this, (l = !(a = ft(e).call(this)) || "object" !== ut(a) && "function" != typeof a ? dt(this) : a).styles = t, l.topPadding = 2, l.y = n, l.width = 120, l.height = 22, l.leftPadding = t.gui.width - l.width - 12, l.obj = o, l.val = s, l.x = i + l.leftPadding, l.uuid = l.uuidv4(), l.children = [], l.visible = !1, l.handleKeys = !1, l.text = o[s], l.setText = l.setText.bind(dt(l)), "Color" === r ? (l.item = new ht.default(t, n, l.obj, l.val, l.uuid, l.setText), l.children.push(l.item)) : "Input" === r && (l.handleKeys = !0), l.cb = h, l }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), e && yt(t, e)
                }(e, lt.default), i = e, (n = [{ key: "setText", value: function(t) { this.text = this.obj[t] || t, this.__onChange && this.__onChange(this.obj[t] || t) } }, { key: "uuidv4", value: function() { return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, function(t) { return (t ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> t / 4).toString(16) }) } }, {
                    key: "updatePos",
                    value: function() {
                        var t = this;
                        this.children.forEach(function(e) { e.y = t.y + e.topPadding, e.x = t.x + e.leftPadding, e.updatePos && e.updatePos() })
                    }
                }, {
                    key: "hideAll",
                    value: function() {
                        var t = this;
                        this.children.forEach(function(e) { e.hide(function() { return t.visible = !1 }) }), this.visible = !1
                    }
                }, {
                    key: "update",
                    value: function(t, e, i, n, o, s, r, h) {
                        var l = !this.clicked;
                        if (this.updateStats(t, e, i, n, o, s), this.handleKeys && h && this.visible) { if ("backspace" === h.toLowerCase()) return void(this.text = this.text.toString().substring(0, this.text.toString().length - 1)); "enter" === h.toLowerCase() && (this.visible = !1), 1 === h.length && (this.text += h), this.obj[this.val] = this.text }
                        this.clicked && l && (this.item && (this.item.visible = !0), this.visible = !0, this.cb())
                    }
                }, {
                    key: "draw",
                    value: function(t) {
                        var e = t.measureText(this.text).width;
                        t.fillStyle = this.styles.input.background, t.fillRect(this.x, this.y, this.width, this.height), t.fillStyle = this.styles.input.color, t.font = this.styles.item.fontSize + " " + this.styles.fontFamily, this.item instanceof ht.default && (t.fillStyle = this.text), t.fillText(this.text, this.x + 2, this.y + this.height / 2 + 4), this.handleKeys && this.visible && (t.strokeStyle = this.styles.input.cursor, t.beginPath(), t.moveTo(e + this.x + 5, this.y + 2), t.lineTo(e + this.x + 5, this.y + this.height - 2), t.stroke())
                    }
                }]) && ct(i.prototype, n), e
            }();
            rt.default = pt;
            ...
            function Pt(t) { return t && t.__esModule ? t : { default: t } }
                ...
                return function(t, e) {
                    ...
                    value: function(t, e, i, n) {
                        ...
                        var o = arguments.length > 5 ? arguments[5] : void 0,
                            ...
                            r = !this.clicked;
                        this.updateStats(t, e, i, n, !1, o, s), this.clicked && r && s(this.uuid)
                    }
                }, {
                    key: "updatePos",
                    value: function() {
                        ...
                        this.children.forEach(function(e) {
                            if (e instanceof xt.default) return e.x = t.x, void(e.y = t.y + t.styles.itemHeight + 2);
                            e.x = t.x + e.leftPadding, e.y = t.y + e.topPadding, e.updatePos && e.updatePos()
                        })
                    }
                }, { key: "draw", value: function(t) { t.fillStyle = this.styles.item.background, t.strokeStyle = this.styles.folder.header.background, t.lineWidth = .7, t.fillRect(this.x - this.leftPadding, this.y, this.width, this.height), t.beginPath(), t.moveTo(this.x - this.leftPadding, this.y + this.height), t.lineTo(this.x + this.width - this.leftPadding, this.y + this.height), t.stroke() } }]) && jt(i.prototype, n), e
            }();
            vt.default = Ct;
            var Tt = {};
            ...
            var Bt = function(t) {
                ...
                return function(t, e) {
                    ...
                    value: function(t, e, i, n, o, s, r) {
                        var h = !this.clicked;
                        t <= this.x || t >= this.x + 28 || (this.updateStats(t, e, i, n, !1, s), this.clicked && h && s && (this.open = !this.open, this.open ? (this.children = this.oldChildren, this.itemCount = this.children.length) : (this.children = this.children.filter(function(t) { return t instanceof Mt.default }), this.itemCount = 1), this.cb()))
                    }
                }, { key: "uuidv4", value: function() { return ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, function(t) { return (t ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> t / 4).toString(16) }) } }, { key: "draw", value: function(t) { t.fillStyle = this.styles.folder.header.background, t.fillRect(this.x, this.y, this.width, this.height), t.strokeStyle = this.styles.folder.header.color, t.lineWidth = 1, this.open ? (t.beginPath(), t.moveTo(this.x + 16 - 5, this.y + this.height / 2 - 5), t.lineTo(this.x + 16 + 5, this.y + this.height / 2 + 5), t.stroke(), t.moveTo(this.x + 16 + 5, this.y + this.height / 2 - 5), t.lineTo(this.x + 16 - 5, this.y + this.height / 2 + 5), t.stroke()) : (t.beginPath(), t.moveTo(this.x + 10, this.y + this.height / 2), t.lineTo(this.x + 10 + 4, this.y + this.height / 2 + 5), t.lineTo(this.x + 20, this.y + 8 + 2), t.stroke()) } }, {
                    key: "updatePos",
                    value: function(t, e, i) {
                        var n = this;
                        this.x = t, this.y = e + i * this.height, this.children.map(function(e) { return e instanceof Mt.default ? (e.x = t + 32, e.y = n.y + n.height + 2, e) : (e.x = t + e.leftPadding, e.y = n.y + n.height * e.id - n.styles.itemHeight, e.updatePos(), e) })
                    }
                }, { key: "add", value: function(t, e, i, n, o) { this.itemCount += 1; var s = new Et.default(this.styles, this.itemCount, t, this.x + 8, this.y, this.width, n, this.object || e, i, o); return this.open ? (this.children.push(s), this.oldChildren.push(s)) : (this.oldChildren.push(s), this.itemCount = 1), s } }]) && Ht(i.prototype, n), e
            }();
            Tt.default = Bt;
            var Ut = {};
            ...
            function Jt(t) { return t && t.__esModule ? t : { default: t } }
            ...
            var qt = function(t) {
                function e(t, i, n, o, s, r) { var h, l, a; return function(t, i) { if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function") }(this), (l = this, a = Xt(e).call(this), h = !a || "object" !== Kt(a) && "function" != typeof a ? function(t) { if (void 0 === t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return t }(l) : a).styles = t, h.x = n, h.y = o, h.leftPadding = s + 4, h.topPadding = 4, h.width = 45, h.height = 20, h.cb = r, h.itemText = new Vt.default(t, i, t.item.fontSize, t.fontFamily, t.button.color, n + h.width / 2, o + h.height + 5, !0), h.children = [h.itemText], h }
                var i, n;
                return function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    ...
                    value: function(t, e, i, n) {
                        var o = !this.clicked;
                        this.updateStats(t, e, i, n, !1, !0), this.clicked && o && this.cb()
                    }
                }, {
                    key: "updatePos",
                    value: function() {
                        var t = this;
                        this.children.forEach(function(e) { e.x = t.x + t.width / 2, e.y = t.y + t.height + 5 })
                    }
                }, { key: "draw", value: function(t) { t.fillStyle = this.styles.item.background, t.fillRect(this.x, this.y, this.width, this.height), t.strokeStyle = this.styles.button.lineTop, t.beginPath(), t.moveTo(this.x, this.y), t.lineTo(this.x + this.width, this.y), t.stroke() } }]) && zt(i.prototype, n), e
            }();
            Nt.default = qt;
            var Zt = {};
            ...
            function ne(t) { return t && t.__esModule ? t : { default: t } }
            ...
            function ye(t) { return t && t.__esModule ? t : { default: t } }
            ...
            return ye(Y),
                function() {
                    function t(e, i, n, o, s, r) { var h = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 1;! function(e, i) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this), this.version = h, this.ctx = e, this.x = i, this.y = n, this.width = o, this.height = s, this.styles = r, this.fixFolders = !1, this.inputManager = new fe.default(e, this.x, this.y, o), this.getSaveData = this.getSaveData.bind(this), this.changePreset = this.changePreset.bind(this), this.updateFolders = this.updateFolders.bind(this), this.folders = [], this.children = [], this.lastChange = (new Date).getTime(), this.canChange = !0, this.visibleUUID = { id: !1, lastChange: (new Date).getTime(), set uuid(t) { this.id = t }, get uuid() { return this.id } }, this.hideChild = this.hideChild.bind(this) }
                    var e, i;
                    return e = t, (i = [{ key: "remember", value: function(t) { this.object = t, this.profileManager = new de.default(this.styles, this.object, this.version, this.x, this.y, this.getSaveData, this.changePreset, this.updateFolders), this.profileManager.loaded && (this.x = this.profileManager.profiles.position.x, this.y = this.profileManager.profiles.position.y, this.profileManager.x = this.x, this.profileManager.y = this.y, this.inputManager.guiX = this.x, this.inputManager.guiY = this.y) } }, { key: "throttled", value: function(t, e) { var i = 0; return function() { var n = (new Date).getTime(); if (!(n - i < t)) return i = n, e.apply(void 0, arguments) } } }, {
                        key: "hideChild",
                        value: function(t) {
                            var e = this;
                            this.visibleUUID.uuid && t !== this.visibleUUID.uuid && this.activeChild.hideAll && (this.canChange = !1, this.activeChild.hideAll && this.activeChild.hideAll(), this.inputManager.actions.isDown = !1, this.inputManager.actions.clicked = !1, setTimeout(function() { return e.canChange = !0 }, 100))
                        }
                    }, {
                        key: "update",
                        value: function() {
                            var t = this,
                                e = this.inputManager.position,
                                i = e.x,
                                n = e.y,
                                o = this.inputManager.actions,
                                s = o.clicked,
                                r = o.isDown;
                            this.inputManager.hotkeys.move && (this.x = i, this.y = n, this.inputManager.guiX = this.x, this.inputManager.guiY = this.y, this.profileManager && this.profileManager.updatePos(this.x, this.y), this.updateFolders()),
                                function e(o) { o.forEach(function(o) { o.update && (o.update(i, n, s, r, t.visibleUUID.uuid, t.canChange, t.hideChild, t.inputManager.inputKey, function(e) { return t.canChange = e }), o.handleKeys && t.inputManager.inputKey && t.inputManager.clearInputKey()), o.children && e(o.children) }) }(this.children)
                        }
                    }, { key: "getSaveData", value: function() { return this.object } }, {
                        key: "flattenChildren",
                        value: function() {
                            var t = this,
                                e = this.profileManager ? [this.profileManager.profileSelect, this.profileManager] : [];
                            ! function i(n) { n.forEach(function(n) { n.draw && (n instanceof ce.default && n.active.visible && (e.push(n), t.visibleUUID.uuid === n.active.uuid && e.push(n.active), t.visibleUUID.uuid !== n.active.uuid && t.canChange && (t.activeChild = n.active, t.lastChange = (new Date).getTime(), t.visibleUUID.uuid = n.active.uuid)), e.push(n)), n instanceof ce.default || n.children && i(n.children) }) }(this.folders), this.children = e.sort(function(t, e) { return t.visible === e.visible ? 0 : t.visible ? 1 : -1 })
                        }
                    }, {
                        key: "changePreset",
                        value: function() {
                            var t = this;
                            if (!(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], this.profileManager.loaded) {
                                var e = this.profileManager.currentValues;
                                this.object = Object.assign(this.object, e.values),
                                    function e(i) { i.forEach(function(i) { i.obj && (i.obj = t.object), i.getDefaultSelected && i.getDefaultSelected(i.obj[i.val]), i.children && e(i.children) }) }(this.folders)
                            } else this.profileManager.saveProfile("Default", this.getSaveData());
                            this.updateFolders()
                        }
                    }, { key: "draw", value: function(t, e) { var i = this; if ((this.ctx || (t && (t instanceof CanvasRenderingContext2D && (this.ctx = t), t instanceof HTMLCanvasElement && (this.ctx = t.getContext("2d"))), this.ctx)) && (e && this.ctx.clearRect(0, 0, this.ctx.canvas.width, this.ctx.canvas.height), this.fixFolders || (this.fixFolders = !0, this.profileManager && this.changePreset(), this.updateFolders()), this.inputManager.hotkeys.hide)) { this.flattenChildren(); var n = 0;! function t(e) { e.forEach(function(e) { e.draw && ((e instanceof ce.default || e instanceof ue.default) && e.height && (n += e.height), e.uuid !== i.visibleUUID.uuid || e.visible || (i.visibleUUID.uuid = !1), i.visibleUUID.uuid || i.canChange || (e.clicked = !1), e.draw(i.ctx)), e instanceof ue.default || e.children && t(e.children) }) }(this.children), this.inputManager.guiHeight = this.profileManager ? this.profileManager.height + n : n, this.inputManager.draw(this.ctx), this.update() } } }, {
                        key: "updateFolders",
                        value: function() {
                            var t = this;
                            this.folders.map(function(e, i) {
                                var n = t.folders[i - 1];
                                e.updatePos(t.x, n ? t.folders[i - 1].y : t.y + (t.profileManager ? t.profileManager.height : 0), n ? t.folders[i - 1].itemCount : 0)
                            }), this.profileManager && this.profileManager.updatePos(this.x, this.y), this.activeChild && this.activeChild.hideAll(), this.flattenChildren()
                        }
                    }, {
                        key: "addFolder",
                        value: function(t) {
                            var e = this,
                                ...
                                n = new ue.default(this.styles, t, this.x, this.y, this.width, this.styles.itemHeight, function() { return e.updateFolders() }, this.object);
                            return i || (n.open = !1), this.folders.push(n), n
                        }
                    }]) && pe(e.prototype, i), t
                }()
        });
        ...
        (function() {
            ...
            const poweredWheelMisc = menu.addFolder("Misc", true)
            ...
            poweredWheelMisc.add("Auto Bunnyhop", window.options, "autoJump", "Check");
            poweredWheelMisc.add("Auto Reload", window.options, "autoReload", "Check");
            poweredWheelMisc.add("Auto Pistol", window.options, "autoPistol", "Check");
            ...
            var hrtCheat = function(me, inputs, world, consts, math, overlay) {
                ...
                // auto pistol
                if (window.options.autoPistol) {
                    if (haveAmmo() && me.weapon.nAuto && mouseLeftDown && me != null && me.health > 0 && me.active) {
                        inputs[SHOOT] = me.didShoot ? 0 : 1;
                    }
                }
